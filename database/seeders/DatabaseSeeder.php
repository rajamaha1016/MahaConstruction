    ...
    public function run(): void
    {
        ...
        if (PackageDetail::count() === 0) {
            PackageDetail::insert([
                ['business_type'=>'construction','division'=>'residential','tier'=>'basic','title'=>'Basic Plan','subtitle'=>'Solid & Affordable','price_per_sqft'=>1999,'is_highlighted'=>0,'warranty_years'=>10,'delivery_months'=>12,'description'=>'A solid, cost-effective residential build using quality materials, standard-grade finishes, and proven structural systems — ideal for budget-conscious homeowners.','features'=>json_encode(['Fe-500 TMT steel','Coromandel / ACC cement','M-Sand blockwork','Vitrified floor tiles (2\'×2\')','Parryware CP fittings','Kundan / Anchor concealed wiring','Flush door entry system','Asian Paints Emulsion finish']),'inclusions'=>json_encode(['Site supervision & structural inspection','Complete civil structural RCC frame','Plastering & structural waterproofing','Concealed electrical conduit & wiring','Complete plumbing & drainage network','Standard sanitaryware & CP bathroom fixtures','Main entrance door with solid frame']),'exclusions'=>json_encode(['Compound wall & designer main gate','Elevator / lift installation','Rooftop solar energy system','Deep borewell drilling & EB line charges']),'created_at'=>now(),'updated_at'=>now()],
                ['business_type'=>'construction','division'=>'residential','tier'=>'premium','title'=>'Premium Plan','subtitle'=>'Quality & Elegance','price_per_sqft'=>2399,'is_highlighted'=>1,'warranty_years'=>15,'delivery_months'=>14,'description'=>'A premium residential construction package with superior materials, polished finishes, and enhanced structural systems — built for growing families seeking elevated quality.','features'=>json_encode(['Fe-550 TMT (JSW / Vizag Steel)','Ultratech Premium / Dalmia cement','Double-washed M-Sand','Kajaria double charged tiles (4\'×2\')','Jaquar sanitary & CP sets','Polycab wires & Roma switches','Teak wood entry door','Asian Paints Apex Ultima']),'inclusions'=>json_encode(['All Basic structural inclusions','Polished granite kitchen counter with SS sink provision','Premium double-charged vitrified floor tiling','CCTV security conduit & surveillance provision','Inverter & power backup wiring provision','Smooth ceiling plastering & acrylic primer finish','Anti-termite foundation soil treatment']),'exclusions'=>json_encode(['Exterior landscaped gardens & paving','Private swimming pool construction','Rooftop solar panel array','High-end home automation hardware']),'created_at'=>now(),'updated_at'=>now()],
                ['business_type'=>'construction','division'=>'residential','tier'=>'luxury','title'=>'Luxury Plan','subtitle'=>'Elite Craftsmanship','price_per_sqft'=>2999,'is_highlighted'=>0,'warranty_years'=>20,'delivery_months'=>18,'description'=>'A fully bespoke luxury residential build using world-class materials, custom architectural details, and premium brand fixtures — crafted for discerning homeowners.','features'=>json_encode(['Fe-550 TMT (Tata Tiscon / JSPL)','Birla Super / ACC Gold cement','River sand / premium concrete sand','Italian Travertine / marble slabs','Kohler / Grohe collection','Finolex cables & Legrand switches','First-grade carved teak doors','Royale textured / custom panel finish']),'inclusions'=>json_encode(['All Premium structural inclusions','Imported Italian marble / grand travertine flooring','Premium polished granite kitchen counter with double sink','Double-height grand ceiling structural framing','Thermal terrace insulation & weatherproofing','Home theatre acoustic civil wall provision','Smart home automation conduit pre-wiring','Premium Kohler / Grohe sanitary & CP collections']),'exclusions'=>json_encode(['Smart home automation devices & sensors','Specialized home theatre AV electronic equipment','Loose structural terrace pergola & jacuzzi setup']),'created_at'=>now(),'updated_at'=>now()],
                ['business_type'=>'construction','division'=>'commercial','tier'=>'basic','title'=>'Standard Shell','subtitle'=>'Functional & Efficient','price_per_sqft'=>2199,'is_highlighted'=>0,'warranty_years'=>10,'delivery_months'=>14,'description'=>'A functional, code-compliant commercial shell ideal for office spaces, retail outlets, and light commercial use — efficient and cost-effective at scale.','features'=>json_encode(['Fe-500 TMT structural steel','OPC 53 grade cement','RCC framed structure','Vitrified floor tiles','Standard plumbing systems','Industrial-grade electrical wiring','Aluminium doors & windows','Exterior cement texture paint']),'inclusions'=>json_encode(['Core structural work & RCC framed structure','Basic MEP (electrical & plumbing) risers','Slab & column reinforced concrete','External weather-resistant plastering','Staircase with MS industrial railing','Commercial-grade heavy traffic flooring','Comprehensive terrace waterproofing']),'exclusions'=>json_encode(['Tenant non-structural internal partitions','Central HVAC chilling plant','Suspended ceiling grid systems','Dedicated fire hydrant network']),'created_at'=>now(),'updated_at'=>now()],
                ['business_type'=>'construction','division'=>'commercial','tier'=>'premium','title'=>'Premium Corporate','subtitle'=>'Professional & Polished','price_per_sqft'=>2799,'is_highlighted'=>1,'warranty_years'=>15,'delivery_months'=>18,'description'=>'A professional-grade commercial building with premium structural detailing, enhanced MEP systems, and modern facade finishes — suited for corporate offices and retail centers.','features'=>json_encode(['Fe-550 TMT (JSW Steel)','Ultratech / Ambuja cement','RCC frame + shear walls','Granite / double charged vitrified','Jaquar / Hindware fixtures','Polycab wires + RCCB MCB panel','Anodized aluminium UPVC systems','Texture + reflective glass curtain']),'inclusions'=>json_encode(['All Standard Shell structural inclusions','Suspended ceiling framing provision','Passenger elevator shaft & machine room','Central HVAC duct routing shaft','Fire hydrant system civil infrastructure','CCTV & biometric access control cabling','Diesel generator power backup foundation']),'exclusions'=>json_encode(['Tenant office furniture & workstations','Dedicated server room IT infrastructure','Tenant-specific loose equipment']),'created_at'=>now(),'updated_at'=>now()],
                ['business_type'=>'construction','division'=>'commercial','tier'=>'luxury','title'=>'Elite Commercial','subtitle'=>'Iconic Architecture','price_per_sqft'=>3499,'is_highlighted'=>0,'warranty_years'=>20,'delivery_months'=>24,'description'=>'An iconic high-end commercial tower built to global standards — with curtain wall facades, high-capacity MEP systems, and architectural features that define city skylines.','features'=>json_encode(['Fe-550D TMT (SAIL / JSPL)','Birla Aditya / ACC Gold cement','Post-tensioned slabs','Stone cladding / premium marble','Geberit / TOTO commercial fixtures','Legrand Mosaic / Schneider systems','Structural glazing curtain wall','EIFS / metal composite facade']),'inclusions'=>json_encode(['All Premium Corporate structural inclusions','Intelligent BMS system conduits','Full automated fire suppression piping','VRF HVAC outdoor deck & piping shafts','High-speed elevator structural shaft & pit','Multi-level basement parking RCC structure','Green building LEED compliance standards','Architectural facade lighting integration']),'exclusions'=>json_encode(['Tenant interior retail fit-outs','Private IT networking & AV studio setup']),'created_at'=>now(),'updated_at'=>now()],
            ]);
