...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .login-brand { font-family: 'Montserrat', sans-serif; font-size: 1.3rem; font-weight: 800; color: #fff; letter-spacing: 0.05em; }
        .login-sub { font-family: 'Montserrat', sans-serif; font-size: 0.75rem; font-weight: 700; color: #D4AF37; letter-spacing: 0.15em; margin-top: 4px; text-transform: uppercase; }
        ...
        .btn-login {
            ...
            color: #050B14; font-weight: 700; font-size: 0.95rem; letter-spacing: 0.05em;
        ...
        .back-link { text-align: center; margin-top: 20px; font-family: 'Montserrat', sans-serif; font-weight: 600; }
        .back-link a { color: #94A3B8; font-size: 0.85rem; text-decoration: none; }
        .back-link a:hover { color: #D4AF37; }

        .footer-note { text-align: center; margin-top: 28px; font-size: 0.72rem; color: #4B5D6B; font-family: 'Inter', sans-serif; }
